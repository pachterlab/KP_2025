...
# write.csv(sleuth::extract_model(so, 'full'), 'hourly_full_model.csv')
# write.csv(X, 'hourly_time_spline.csv')
# write.csv(sleuth_de, 'hourly_de_genes.csv')
# write.csv(sleuth::sleuth_to_matrix(so, 'obs_norm', 'est_counts'), 'hourly_mtx.csv')
# write.csv(sleuth::sleuth_to_matrix(so, 'obs_norm', 'tpm'), 'hourly_tpm.csv')